...
exports.remove_one = exports.remove_all = exports.remove_many = exports.remove_id = void 0;
var mongodb_1 = require("mongodb");
var process_1 = require("process");
function remove_id(db, collectionName, query) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, collection.deleteOne({ _id: new mongodb_1.ObjectId(query) })];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
...
function remove_many(db, collectionName, query) {
    return __awaiter(this, void 0, void 0, function () {
...
function remove_all(db, collectionName) {
    return __awaiter(this, void 0, void 0, function () {
...
function remove_one(db, collectionName, query) {
    return __awaiter(this, void 0, void 0, function () {
        var collection, data, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (query == null || collectionName == null || db == null) {
